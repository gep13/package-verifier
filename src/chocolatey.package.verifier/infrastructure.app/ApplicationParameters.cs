...
namespace chocolatey.package.verifier.Infrastructure.App
{
    ...
    public static class ApplicationParameters
    {
        ...
        {
            get { return try_get_config(() => Config.GetConfigurationSettings().IsDebugMode, false); }
        }
        ...
        {
            get { return ConfigurationManager.AppSettings["InsertTestData"].Equals(bool.TrueString, StringComparison.InvariantCultureIgnoreCase); }
        }
        ...
        {
            get { return Config.GetConfigurationSettings().SiteUrl; }
        }
        ...
        {
            get { return Config.GetConfigurationSettings().RepositoryCacheIntervalMinutes; }
        }
