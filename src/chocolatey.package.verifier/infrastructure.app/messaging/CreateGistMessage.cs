// <copyright company="RealDimensions Software, LLC" file="CreateGistMessage.cs">
...
namespace chocolatey.package.verifier.infrastructure.app.messaging
{
    ...
    {
        public CreateGistMessage(string installationLog, string uninstallationLog)
        {
            this.InstallationLog = installationLog;
            this.UninstallationLog = uninstallationLog;
        }
